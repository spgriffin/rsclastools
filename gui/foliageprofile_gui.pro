...
PRO FoliageProfile_GUI
  ...
  text = WIDGET_LABEL(Base6, value='4. Apparant Foliage Profile', frame=0, /align_left)
  text = WIDGET_LABEL(Base6, value='5. Derivative of Apparant Foliage Profile', frame=0, /align_left)
